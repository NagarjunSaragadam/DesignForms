(function($) {
    ...
    `;
        ...
        $('.page-list-table-' + $tableId).append('<a class="table-pagination-prev-btn-' + $tableId + '">Pre</a>');

        for (i = 0; i < $totalPage; i++) {
            $('.page-list-table-' + $tableId).append('<a class="table-pagination-pagination-num-' + $tableId + '"  data-page-id="' + (i + 1) + '" >' + (i + 1) + '</a>');
        }
        $('.page-list-table-' + $tableId).append('<a class="table-pagination-next-btn-' + $tableId + '">Last</a>');
