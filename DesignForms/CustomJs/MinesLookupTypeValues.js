var durl = 'MinesLookupTypeValues/MinesLookUpTypeModification';
...
function SaveOrder() {
    ...
    if (requestJson.resultList.length > 0) {
        ...
        $.ajax({
            url: 'MinesLookupTypeValues/SaveMinesLookupvaluesOrder',
            type: 'Post',
...
function toJson() {
    return Reason = { Guid: $("#hdnGuid").val(), LookupValueCode: $('#Code').val(), LookupValueName: $('#Name').val(), LookupId: $('#hdntypeGuid').val() };
};
